...
START_TEST(f_specifier_testing) {
    ...
    int printCount = sprintf(result, format, 4, 50.91, 50.214, 50.87, 50.878787, 50.87687, 50.7777, 50.4655, 50.87769, 50.65554, 50.6558, 50.866427659, 100000000000.76443553, 50.75475465);
    int printCount2 = s21_sprintf(result2, format, 4, 50.91, 50.214, 50.87, 50.878787, 50.87687, 50.7777, 50.4655, 50.87769, 50.65554, 50.6558, 50.866427659, 100000000000.76443553, 50.75475465);
    char result3[400];
    char result4[400];
    int printCount3 = sprintf(result3, format, 4, -50.91, -50.214, -50.87, -50.878787, -50.87687, -50.7777, -50.4655, -50.87769, -50.65554, -50.6558, -50.866427659, -100000000000.76443553, -50.75475465);
    int printCount4 = s21_sprintf(result4, format, 4, -50.91, -50.214, -50.87, -50.878787, -50.87687, -50.7777, -50.4655, -50.87769, -50.65554, -50.6558, -50.866427659, -100000000000.76443553, -50.75475465);
    ck_assert_str_eq(result, result2);
    ck_assert_str_eq(result3, result4);
    ck_assert_int_eq(printCount, printCount2);
    ck_assert_int_eq(printCount3, printCount4);
